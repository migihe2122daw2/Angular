...
@Component({
  selector: 'app-videjocs-ios',
  templateUrl: './videjocs-ios.component.html',
  styleUrls: ['./videjocs-ios.component.css'],
  animations: [
...
export class VidejocsIosComponent implements OnInit {
  ...
  private async loadVideojocs() {
    const videojocs = await this.videojocsService.listarVideojocsIOS();
