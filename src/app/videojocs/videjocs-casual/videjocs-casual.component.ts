...
@Component({
  selector: 'app-videjocs-casual',
  templateUrl: './videjocs-casual.component.html',
  styleUrls: ['./videjocs-casual.component.css'],
  animations: [
...
export class VidejocsCasualComponent implements OnInit {
  ...
  private async loadVideojocs() {
    const videojocs = await this.videojocsService.listarVideojocsCasual();
