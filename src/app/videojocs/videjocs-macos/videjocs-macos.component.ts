...
@Component({
  selector: 'app-videjocs-macos',
  templateUrl: './videjocs-macos.component.html',
  styleUrls: ['./videjocs-macos.component.css'],
  animations: [
...
export class VidejocsMacosComponent implements OnInit {
  ...
  private async loadVideojocs() {
    const videojocs = await this.videojocsService.listarVideojocsMacOS();
