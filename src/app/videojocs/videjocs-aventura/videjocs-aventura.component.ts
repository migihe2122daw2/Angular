...
@Component({
  selector: 'app-videjocs-aventura',
  templateUrl: './videjocs-aventura.component.html',
  styleUrls: ['./videjocs-aventura.component.css'],
  animations: [
...
export class VidejocsAventuraComponent implements OnInit {
  ...
  private async loadVideojocs() {
    const videojocs = await this.videojocsService.listarVideojocsAventura();
