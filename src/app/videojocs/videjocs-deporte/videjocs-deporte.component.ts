...
@Component({
  selector: 'app-videjocs-deporte',
  templateUrl: './videjocs-deporte.component.html',
  styleUrls: ['./videjocs-deporte.component.css'],
  animations: [
...
export class VidejocsDeporteComponent implements OnInit {
  ...
  private async loadVideojocs() {
    const videojocs = await this.videojocsService.listarVideojocsDeportes();
