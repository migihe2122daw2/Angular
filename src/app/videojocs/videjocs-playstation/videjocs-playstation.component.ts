...
@Component({
  selector: 'app-videjocs-playstation',
  templateUrl: './videjocs-playstation.component.html',
  styleUrls: ['./videjocs-playstation.component.css'],
  animations: [
...
export class VidejocsPlaystationComponent implements OnInit {
  ...
  private async loadVideojocs() {
    const videojocs = await this.videojocsService.listarVideojocsPlaystation();
  ...
  private async loadDescription(videojoc: any) {
    ...
    // Hacer que los elementos html de la descriplaystationion sean interpretados como html
