...
@Component({
  selector: 'app-videjocs-nintendo',
  templateUrl: './videjocs-nintendo.component.html',
  styleUrls: ['./videjocs-nintendo.component.css'],
  animations: [
...
export class VidejocsNintendoComponent implements OnInit {
  ...
  private async loadVideojocs() {
    const videojocs = await this.videojocsService.listarVideojocsNintendo();
