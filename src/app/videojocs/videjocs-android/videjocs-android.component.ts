...
@Component({
  selector: 'app-videjocs-android',
  templateUrl: './videjocs-android.component.html',
  styleUrls: ['./videjocs-android.component.css'],
  animations: [
...
export class VidejocsAndroidComponent implements OnInit {
  ...
  private async loadVideojocs() {
    const videojocs = await this.videojocsService.listarVideojocsAndroid();
