...
@Component({
  selector: 'app-videjocs-wii',
  templateUrl: './videjocs-wii.component.html',
  styleUrls: ['./videjocs-wii.component.css'],
  animations: [
...
export class VidejocsWiiComponent implements OnInit {
  ...
  private async loadVideojocs() {
    const videojocs = await this.videojocsService.listarVideojocsWii();
  ...
  private async loadDescription(videojoc: any) {
    ...
    // Hacer que los elementos html de la descriwiiion sean interpretados como html
