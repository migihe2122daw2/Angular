...
@Component({
  selector: 'app-videjocs-pc',
  templateUrl: './videjocs-pc.component.html',
  styleUrls: ['./videjocs-pc.component.css'],
  animations: [
...
export class VidejocsPcComponent implements OnInit {
  ...
  private async loadVideojocs() {
    const videojocs = await this.videojocsService.listarVideojocsPC();
