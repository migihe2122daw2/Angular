...
@Component({
  selector: 'app-videjocs-xbox',
  templateUrl: './videjocs-xbox.component.html',
  styleUrls: ['./videjocs-xbox.component.css'],
  animations: [
...
export class VidejocsXboxComponent implements OnInit {
  ...
  private async loadVideojocs() {
    const videojocs = await this.videojocsService.listarVideojocsXbox();
  ...
  private async loadDescription(videojoc: any) {
    ...
    // Hacer que los elementos html de la descrixboxion sean interpretados como html
