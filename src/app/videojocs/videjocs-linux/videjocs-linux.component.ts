...
@Component({
  selector: 'app-videjocs-linux',
  templateUrl: './videjocs-linux.component.html',
  styleUrls: ['./videjocs-linux.component.css'],
  animations: [
...
export class VidejocsLinuxComponent implements OnInit {
  ...
  private async loadVideojocs() {
    const videojocs = await this.videojocsService.listarVideojocsLinux();
